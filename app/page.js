  ...
  const services = [
    {
      ...
      title: "중고제품 수거",
      description:
        "사용하지 않는 가전제품과 가구를 편리하게 수거해드립니다. 간편한 예약 시스템으로 원하는 날짜와 시간을 선택하세요.",
    },
    {
      icon: TrendingUp,
      title: "재판매 서비스",
      description:
        "수거한 제품을 검수하고 재생하여 합리적인 가격에 판매합니다. 환경도 지키고 경제적인 혜택도 누리세요.",
    },
    {
      icon: Users,
      title: "이용객 편의성",
      description:
        "복잡한 절차 없이 온라인으로 모든 과정을 진행할 수 있습니다. 고객님의 시간과 노력을 아껴드립니다.",
    },
  ];
  ...
  const steps = [
    {
      number: "01",
      title: "예약 신청",
      description: "온라인으로 간편하게 수거 또는 구매 예약",
    },
    {
      number: "02",
      title: "방문 수거",
      description: "약속된 시간에 전문 팀이 방문하여 수거",
    },
    {
      number: "03",
      title: "검수 및 재생",
      description: "제품 상태 확인 및 필요시 수리 진행",
    },
    {
      number: "04",
      title: "판매 및 배송",
      description: "온라인 플랫폼을 통한 재판매 및 배송",
    },
  ];
      ...
      <section className="bg-gradient-to-br from-white via-primary/5 to-secondary/10 py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
            사용하지 않는 가전제품과 가구에 새로운 생명을 불어넣습니다.
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/products"
              className="bg-secondary text-secondary-foreground px-8 py-4 rounded-lg font-semibold hover:opacity-90 transition-opacity"
            >
              중고제품 둘러보기
            </Link>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-primary to-secondary">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-white/90 mb-8">
            대전 지역 최고의 중고제품 순환 플랫폼, Reborn과 함께
            <br />
      ...
      <footer className="bg-foreground text-background py-12 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-4">
            ...
            <span className="text-sm ml-2 text-background/70">
              자원 재탄생 플랫폼
            </span>
          </div>
          <p className="text-background/70 text-sm">
            대전광역시 중고제품 수거 및 판매 서비스
          </p>
